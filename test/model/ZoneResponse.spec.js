...
configureModule(function (expect, Hume) {
  ...
  // Variable to hold an instance of ZoneResponse
  var instance;

  // Test suite for the ZoneResponse
  describe('(package)', function() {
    describe('ZoneResponse', function() {

      // Setup a new instance before each test
      beforeEach(function() {
        instance = new Hume.ZoneResponse();
      });

      // Test case to check if it creates an instance of ZoneResponse
      it('should create an instance of ZoneResponse', function() {
        // TODO: update the code to test ZoneResponse
        expect(instance).to.be.a(Hume.ZoneResponse);
      });
