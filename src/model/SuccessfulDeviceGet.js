...
commonModuleLoader(this, function(ApiClient) {
  ...
  /**
   * The SuccessfulDeviceGet model module.
   * @module model/SuccessfulDeviceGet
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>SuccessfulDeviceGet</code>.
   * @alias module:model/SuccessfulDeviceGet
   * @class
   * @param name {String} 
  ...
  /**
   * Constructs a <code>SuccessfulDeviceGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SuccessfulDeviceGet} obj Optional instance to populate.
   * @return {module:model/SuccessfulDeviceGet} The populated <code>SuccessfulDeviceGet</code> instance.
   */
